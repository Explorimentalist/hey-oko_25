...
export function HomeAbout() {
  ...
  const fullText = "I’m Ngatye Brian Oko, a branch of the African tree, born in the land of tapas and living in the city of Big Ben. I have over a decade of experience shaping digital products with curiosity and a holistic edge. I work at the intersection of Product Design and Storytelling, obsessively augmented by AI technology, helping businesses become more human, more profitable, and harder to ignore.";
