...
const ARCHIVE_ITEMS: ArchiveEntry[] = [
  ...
  },
  {
    ...
    impact: 'Connection with network',
  ...
  },
  {
    ...
    impact: 'Quicker and consistent design outputs',
  ...
  },
  {
    year: '2020',
    project: 'DTB',
    contribution: 'Mobile UX/UI Design, Animation',
    impact: ' ',
